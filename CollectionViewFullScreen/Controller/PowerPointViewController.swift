...
class PowerPointViewController: UIViewController {

    
    let headingLabel = Label(text: "Welcome to PowerPoint", font: .systemFont(ofSize: 18, weight: .black), textColor: .black)
