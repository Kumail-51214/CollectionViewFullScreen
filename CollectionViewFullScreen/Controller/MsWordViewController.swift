...
class MsWordViewController: UIViewController {

    let headingLabel = Label(text: "Welcome to MsWord", font: .systemFont(ofSize: 18, weight: .black), textColor: .black)
