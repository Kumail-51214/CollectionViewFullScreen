...
class MsExcelViewController: UIViewController {

    let headingLabel = Label(text: "Welcome to MsExcel", font: .systemFont(ofSize: 18, weight: .black), textColor: .black)
